#
#  Be sure to run `pod spec lint VLCardBaseCollectionView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Van Dinh Luu" => "valu4298@gmail.com" }
  # Or just: s.author    = "Van Luu"
  s.authors            = { "Van Dinh Luu" => "valu4298@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Van Luu"
  ...
  s.source       = { :git => "https://github.com/vl4298/VLCardBaseCollectionView.git", :tag => "#{s.version}" }
